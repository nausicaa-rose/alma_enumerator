...
def get_info_from_description(item):
    ...
    # Otherwise, keep cleaning the data.
        ...
        for i in item.parse_me:     
            ...
            item.parse_me[item.parse_me.index(i)] = bad_chars_p.sub('', i)
            i = bad_chars_p.sub('', i)
        ...
        # TODO
        # If a field begins or ends with a hyphen, slash or ampersand, split
        # the symbol into its own field
    ...
    if item.error:
        ...
        if i_len == 7:
            ...
            if has_digits_p.match(info[2]) == None and has_digits_p.match(info[5]) == None and rp.match(info[4]) != None:
       ...
       # ['no.42', 'Win', '2009', '-', 'Win', '2010']
            ...
            item_info['enumeration_a'] = snarf_numerals(info[0])
            if has_digits_p.match(info[1]) == None and has_digits_p.match(info[4]) == None and rp.match(info[3]) != None:              
                if info[2] == info[5]:
        ...
        # ['v.43 'no.2', '4', 'Mar', '2009'] or ['v.43 'no.2', 'Mar', '4', '2009']
            ...
            if has_digits_p.match(info[2]) != None and rp.match(info[3]) == None:
            ...
            elif has_digits_p.match(info[1]) != None:
            ...
            elif has_digits_p.match(info[1]) == None and rp.match(info[3]) != None:
        ...
        # issue, month, day, year or volume, issue, month, year
            ...
            if has_digits_p.match(info[1]) == None:
                item_info['chronology_j'] = info[1]
                item_info['chronology_k'] = snarf_numerals(info[2])
        ...
        # the second field should be the year(s), so set it to chronology_i.
            ...
            if has_digits_p.match(info[0]) != None and has_digits_p.match(info[1]) != None:
            ...
            elif has_digits_p.match(info[0]) != None and has_digits_p.match(info[1]) == None:
